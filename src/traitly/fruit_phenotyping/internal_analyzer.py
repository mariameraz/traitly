# traitly/fruit_phenotyping/internal_analyzer.py
...
class FruitInternalAnalyzer:
    ...
    def save_parameters(self, output_path: Optional[str] = None) -> None:
        ...
        txt_path = os.path.join(output_path, f"{base_name}_metadata.txt")
        self.parameters.save_to_file(txt_path)
        
        # Guardar como .json (para programar)
        json_path = os.path.join(output_path, f"{base_name}_metadata.json")
    ...
    def analyze_color(self, 
        ...
        if get_color_distribution:
            color_results = get_fruit_color_distributions(img = self.img,
    ...
    def detect_color_checker(self, plot: bool = False, plot_size=(5,5), verbose: bool = True, scale_factor: float = 0.5):
            ...
            # NOTE: img_small is RGB; CCheckerDraw works in RGB space.
            ...
            # Scale box_points to full-resolution for bounding rect / ROI extraction
    ...
    def process_single_file(
        ...
        # Load parameters using json file (Optional)
    ...
    def analyze_folder(
        ...
        get_color_distribution: Optional[bool] = None,
