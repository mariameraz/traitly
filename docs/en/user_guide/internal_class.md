...
analyzer = FruitInternalAnalyzer(path = "path/to/my/image.jpg")

# To analyze multiple images in a folder
analyzer = FruitInternalAnalyzer(path = "path/to/my/folder/with/images/")
```
