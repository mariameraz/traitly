...
The project's architecture and core logic are established, and early testers are currently evaluating the tool across different workflows, and use cases. We expect to upload our package to PyPI soon.

Updates will be announced through this repository and [LinkedIn](https://www.linkedin.com/in/alemeraz/). Interested users are encouraged to follow or watch the repository to stay informed.
...
There are different ways to run our Traitly:
...
For questions regarding the project, please reach out to:
...
We thank the developers of  [OpenCV](https://opencv.org/), [Ultralytics](https://github.com/ultralytics/ultralytics), [EasyOCR](https://github.com/JaidedAI/EasyOCR), [NumPy](https://numpy.org/), [Pandas](https://pandas.pydata.org/), [Matplotlib](https://matplotlib.org/), and [Shiny](https://shiny.posit.co/py/) and all  open-source libraries that made this project possible.
